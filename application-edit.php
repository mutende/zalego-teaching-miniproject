              ...
              <form action="" method="post">
                 ...
                 <div class="form-group">
                  ...
                  <?php while($row_courses = mysqli_fetch_assoc($query2)) { ?>
                           <option value="<?php echo $row_courses['courseId']?>"><?php echo $row_courses['courseName'] . " for " . $row_courses['courseDuration']. " months at " .$row_courses['courseFee'] ;?></option>    
               <?php } ?>
             </select>
                  </div>
                  <div class="form-group">
                  ...
                  <input type="hidden" value="<?php echo $row_student['appliedId'];?>" name="appliedId">
